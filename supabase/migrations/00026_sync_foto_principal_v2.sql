...
-- Sincroniza foto_principal_url para TODOS los espacios con fotos en galería
-- pero sin foto_principal_url (incluye espacios con fotos añadidas recientemente)
